...
def run(lines):
    ...
    while pipe:
        pipe.seen = True
        grid[pipe.y][pipe.x] = pipe.tile

        # this finds the pipe path
        new_pipe = None
    ...
    # iterate over grid connections? see if it's part of the same area
    # but then you have to deal with zero width thing
